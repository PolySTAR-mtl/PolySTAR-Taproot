...
// Same as AutoAim but no delay on match start
...
HoldCommandMapping startFlywheelManual(drivers(), {&flywheelStartManual}, RemoteMapState(Remote::Switch::RIGHT_SWITCH, Remote::SwitchState::DOWN));
/*-Turret-*/
/*-Chassis-*/
