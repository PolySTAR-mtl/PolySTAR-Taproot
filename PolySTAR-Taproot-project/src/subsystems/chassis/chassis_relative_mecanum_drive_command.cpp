#include "chassis_relative_mecanum_drive_command.hpp"
...
namespace chassis
{
ChassisRelMecanumDriveCommand::ChassisRelMecanumDriveCommand(
...
void  ChassisRelMecanumDriveCommand::initialize() {}

void  ChassisRelMecanumDriveCommand::execute()
{
...
void  ChassisRelMecanumDriveCommand::end(bool) { chassis->setTargetOutput(0, 0, 0); }

bool  ChassisRelMecanumDriveCommand::isFinished() const { return false; }
}  // namespace chassis
}  // namespace control
