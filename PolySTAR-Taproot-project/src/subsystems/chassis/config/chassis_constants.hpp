 ...
 */
static constexpr float CHASSIS_PID_KP = 20.f;
static constexpr float CHASSIS_PID_KI = 0.f;
static constexpr float CHASSIS_PID_KD = 1.f;
static constexpr float CHASSIS_PID_MAX_ERROR_SUM = 5000.f;
static constexpr float CHASSIS_PID_MAX_OUTPUT = 16000.f;
static constexpr float CHASSIS_TQ_DERIVATIVE_KALMAN = 1.f;
static constexpr float CHASSIS_TR_DERIVATIVE_KALMAN = 1.f;
static constexpr float CHASSIS_TQ_PROPORTIONAL_KALMAN = 1.f;
static constexpr float CHASSIS_TR_PROPORTIONAL_KALMAN = 0.f;
 ...
 */
static constexpr float CHASSIS_SHIFT_MULTIPLIER = 1.f;
 ...
 */
static constexpr float CHASSIS_DEAD_ZONE = 0.05f;
 ...
 */
static constexpr float ROTATION_SPEED_HIGH = 0.75f * 1.f;
static constexpr float ROTATION_SPEED_LOW = 0.5f * 1.f;
...
static constexpr float VX_TO_X = 0.5e-3f; // 1m/s = 0.5 on chassis x
static constexpr float VY_TO_Y = 0.5e-3f; // 1m/s = 0.5 on chassis y
static constexpr float W_TO_R = 0.07955f; // 1rps = 0.5 on chassis r
