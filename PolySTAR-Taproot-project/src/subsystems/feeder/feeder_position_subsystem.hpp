 ...
 */
class FeederPositionSubsystem : public tap::control::setpoint::SetpointSubsystem
{
public:
    ...
    FeederPositionSubsystem &operator=(const FeederPositionSubsystem &other) = delete;

    ~FeederPositionSubsystem() = default;
